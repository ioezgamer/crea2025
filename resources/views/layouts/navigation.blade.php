...
x-bind:class="{ 
    ...
    'w-full': open && window.innerWidth < 768 
}" 
...
:class="{ 'translate-x-0': open || window.innerWidth >= 768, '-translate-x-full': !open && window.innerWidth < 768 }"
    ...
    <div class="h-full flex flex-col">
        ...
        <div class="flex items-center justify-between px-4 py-4 border-b border-gray-700">
            <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                ...
                <span x-show="sidebarOpen || window.innerWidth < 768" class="text-xl font-bold">Tu Proyecto</span>
            </a>
            <div class="flex items-center space-x-2">
                <button x-show="window.innerWidth >= 768" 
                    ...
                    <svg x-show="sidebarOpen" class="h-6 w-6" fill="none" stroke="current ningunoColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 overflow-y-auto pt-4 px-2 space-y-2">
            <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" count="585">
                <div class="flex items-center space-x-3">
                    ...
                    <span x-show="sidebarOpen || window.innerWidth < 768">Total Inscritos</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('programas')" :active="request()->routeIs('programas')" count="3">
                <div class="flex items-center space-x-3">
                    ...
                    <span x-show="sidebarOpen || window.innerWidth < 768">Programas Activos</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('participante.index')" :active="request()->routeIs('participante')" count="7">
                <div class="flex items-center space-x-3">
                    ...
                    <span x-show="sidebarOpen || window.innerWidth < 768">Lugares de Encuentro</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('asistencia.create')" :active="request()->routeIs('asistencia')" count="0">
                <div class="flex items-center space-x-3">
                    ...
                    <span x-show="sidebarOpen || window.innerWidth < 768">Asistencia</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('asistencia.reporte')" :active="request()->routeIs('asistencia')" count="5">
                <div class="flex items-center space-x-3">
                    ...
                    <span x-show="sidebarOpen || window.innerWidth < 768">Reportes Asistencia</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('tutores')" :active="request()->routeIs('tutores')" count="12">
                <div class="flex items-center space-x-3">
                    ...
                    <span x-show="sidebarOpen || window.innerWidth < 768">Tutores</span>
                </div>
            </x-nav-link>
            ...
            <x-nav-link :href="route('tutores_participantes')" :active="request()->routeIs('tutores_participantes')" count="20">
                <div class="flex items-center space-x-3">
                    ...
                    <span x-show="sidebarOpen || window.innerWidth < 768">Tutores y Participantes</span>
                </div>
            </x-nav-link>
            ...
            @can('manage-roles')
                <x-nav-link :href="route('roles.index')" :active="request()->routeIs('roles.index')" count="9">
                    <div class="flex items-center space-x-3">
                        ...
                        <span x-show="sidebarOpen || window.innerWidth < 768">Roles</span>
                    </div>
                </x-nav-link>
            @endcan
        </div>
            ...
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    <button class="flex items-center space-x-3 w-full text-gray-300 hover:bg-gray-700 rounded-lg px-3 py-2 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-white">
                        ...
                        <div x-show="sidebarOpen || window.innerWidth < 768" class="flex-1 flex flex-col text-left">
                            <span class="text-sm font-medium">{{ Auth::user()->name }}</span>
                            <span class="text-xs text-gray-400">{{ Auth::user()->email }}</span>
                        </div>
                        <svg x-show="sidebarOpen || window.innerWidth < 768" class="h-4 w-4 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
:class="{ 'hidden': !open && window.innerWidth < 640, 'block': open && window.innerWidth < 640 }"
...
aria-label="Navegación Principal">
    <div class="h-full flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto pt-4 px-2 space-y-2">
            ...
            <x-nav-link :href="route('asistencia.create')" :active="request()->routeIs('asistencia')" count="0">
                <div class="flex items-center space-x-3">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 14 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="-me-2 flex items-center sm:hidden fixed top-4 right-4 z-50">
        <button @click="open = !open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out bg-gray-800">
